     ...
     */
{
     ...
     *             @OA\Property(property="email", type="string", description="Email de l'utilisateur", example="admin@bankapi.com"),
     *             @OA\Property(property="password", type="string", format="password", description="Mot de passe", example="password")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
